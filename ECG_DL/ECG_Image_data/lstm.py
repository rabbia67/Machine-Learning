...
from tensorflow.keras.layers import Conv2D, BatchNormalization, MaxPooling2D, Flatten, Dense, Reshape, LSTM, Dropout
...
def create_lstm_model():
    """
    Create an LSTM-based model for binary classification.
    """
    model = Sequential([
        ...
        # Reshaping the flattened image data into sequences
        Dense(128, activation='relu'),
        BatchNormalization(),
        Reshape((128, 1)),  # Reshape to make it compatible with LSTM input
    ...
    logging.info("LSTM-based model created and compiled.")
    return model
...
def main():
    try:
        ...
        logging.info("Creating and training LSTM model...")
